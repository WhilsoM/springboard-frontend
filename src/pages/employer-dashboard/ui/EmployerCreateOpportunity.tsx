...
import { createOpportunitySchema, type CreateOpportunityValues } from '../model'
...
export const EmployerCreateOpportunity = () => {
  ...
  } = useForm<CreateOpportunityValues>({
    ...
    <div className="min-h-screen bg-[#F8FAFC] p-4 md:p-10 text-slate-900">
      <div className="mx-auto max-w-5xl space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          >
            <Save size={20} /> {isSubmitting ? 'Сохранение...' : 'Создать вакансию'}
          </Button>
        </div>
          ...
          <div className="space-y-8">
            <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-2xl space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <span className="text-[10px] font-black text-slate-500 tracking-widest">ОТ</span>
                  <Input
                    {...register('salary_min')}
                    type="number"
                ...
                <div className="space-y-1">
                  <span className="text-[10px] font-black text-slate-500 tracking-widest">ДО</span>
                  <Input
                    {...register('salary_max')}
                    type="number"
                    className="bg-white/5 border-white/10 focus:border-blue-500 rounded-xl text-white h-12"
